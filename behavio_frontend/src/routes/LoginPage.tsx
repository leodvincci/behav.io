    ...
    <section className="min-h-screen min-w-full grid grid-cols-1 lg:grid-cols-2 place-content-center place-items-center tracking-wide text-black">
      ...
      <div className="bg-accent h-screen w-full flex-col flex items-center justify-center gap-20">
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-6 w-9/12">
          <label>
            <input
              className="w-full p-2 rounded bg-secondary shadow"
              type="text"
          ...
          {isError ? (
            <p className="text-error font-bold text-center">{errorMessage}</p>
          ) : (
            <p className="h-6"></p>
          )}
          <button className="btn text-secondary w-3/12 mx-auto tracking-widest bg-primary-light hover:bg-primary-dark shadow-lg hover:shadow-xl active:shadow-lg">
            Login
          </button>
        </form>
        <p className="text-primary text-center">
          ...
          <Link
            to="/registration"
            className="text-offBlue hover:text-offBlue-dark active:text-blue-900 underline tracking-wider ml-1"
          >
            Register
          </Link>
        </p>
