    ...
    <section className="min-h-screen min-w-full grid grid-cols-1 lg:grid-cols-2 place-content-center place-items-center uppercase tracking-wide text-black">
      ...
      <div className='bg-accent h-screen w-full flex-col flex items-center justify-center gap-20'>
        ...
        <form onSubmit={handleLogin} className='flex flex-col gap-6 w-9/12'>
          <input value={first_name} className='p-2 rounded bg-secondary shadow' type="text" placeholder="First name"  onChange={e => setFirstName(e.target.value)} />
          <input value={last_name} className='p-2 rounded bg-secondary shadow' type="text" placeholder="Last name"  onChange={e => setLastName(e.target.value)} />
          <input value={email} className='p-2 rounded bg-secondary shadow' type="text" placeholder="Email"  onChange={e => setEmail(e.target.value)} />
          <input value={password} className='p-2 rounded bg-secondary shadow' type="password" placeholder="Password" onChange={e => setPassword(e.target.value)} />
